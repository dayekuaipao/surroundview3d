...
void OmniCameraModel::readKD(string path)
{
...
void OmniCameraModel::writeKD(string path)
{
...
void OmniCameraModel::project(InputArrayOfArrays p3ds,OutputArrayOfArrays p2ds)
{
